...
public class TestEntry {
	...
	public void test_entry_1() {
		...
		// Does not always work since this compares address rather than the string itself
		// 		assertTrue(e.getSerialNumber() == "F9DN4NKQ1GC");
		assertEquals("F9DN4NKQ1GC", e.getSerialNumber());
		assertTrue(e.getProduct() == p); // works because you are looking for same address
		assertSame(e.getProduct(), p); // SAME ADDRESS

		// testing toString() method in Entry class
